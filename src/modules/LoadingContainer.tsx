...
const LoadingContainer = ({file, setUrl} : any) => {
    const uploadImg = () => {
  ...
  return (
    <div className='flex flex-col justify-between align-middle text-gray-600 py-10 px-8 m-auto w-1/3 h-1/4 bg-white rounded-xl shadow-lg shadow-gray-300/75'>
        <h2 className='text-xl font-semibold text-gray-700 mb-5'>Uploading...</h2>
